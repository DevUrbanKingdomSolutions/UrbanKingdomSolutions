const APP_SHELL_CACHE = "production-crew-shell-v1.04.091";
const APP_SHELL_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=V1.04.091-message-sender-avatar-colors",
  "./app.js?v=V1.04.091-message-sender-avatar-colors",
  "./release-notice.json",
