const APP_SHELL_CACHE = "production-crew-shell-v1.04.092";
const APP_SHELL_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=V1.04.092-nonblocking-message-notifications",
  "./app.js?v=V1.04.092-nonblocking-message-notifications",
  "./release-notice.json",
