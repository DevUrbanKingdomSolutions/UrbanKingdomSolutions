const APP_SHELL_CACHE = "production-crew-shell-v1.05.007";
const APP_SHELL_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=V1.05.007-admin-console-column-controls",
  "./app.js?v=V1.05.007-admin-console-column-controls",
  "./release-notice.json",
