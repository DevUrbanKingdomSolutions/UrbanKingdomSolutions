const APP_SHELL_CACHE = "production-crew-shell-v1.05.006";
const APP_SHELL_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=V1.05.006-runner-status-column-controls",
  "./app.js?v=V1.05.006-runner-status-column-controls",
  "./release-notice.json",
